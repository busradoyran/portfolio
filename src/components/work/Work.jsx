    ...
    <div id="projects" className="container m-auto mt-16">
      ...
      data-aos="fade-up"
       className="relative mb-5">
        <h3 className="text-3xl font-black text-gray-400 sm:text-2xl">Freelance Projects</h3>
      ...
      data-aos="fade-up"
       className="left flex-1 w-full">
        <p className="text-gray-700 font-medium w-[100%]">
          Here are some of my freelance projects where I've helped businesses solve real-world problems.
        </p>
      </div>
      {/* card */}
